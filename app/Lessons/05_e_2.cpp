...
int main() {
  ...
  //     shader
  Shader ourShader(
      "./resources/Shaders/05/e2_vertexShader.glsl",
      "./resources/Shaders/05/e2_fragmentShader.glsl"); // you can name your
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    float a = abs(sin(glfwGetTime()));
    transform = glm::scale(transform, glm::vec3(a, a, a));
